package com.jdev.videofilters.ui.views;
...
import com.jdev.videofilters.render.MovieRenderThread;
import com.jdev.videofilters.render.MovieRenderer;
import com.jdev.videofilters.render.RecordRenderThread;
import com.jdev.videofilters.utils.ConfigUtils;
import com.jdev.videofilters.utils.VideoInfoUtils;
...
public class VideoFilterView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void handleSaveCompleted() {
        ...
        Toast.makeText(getContext(), "Video Saved In：" + mOutputFile, Toast.LENGTH_SHORT).show();
    }
